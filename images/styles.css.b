...
.menu2 ul li.group {display:block; text-indent:10px; background:#666; color:#cc0000; width:150px; padding:4px 0;}
...
display:block; position:absolute;top:24px; background:#aaa; margin-top:1px; left:0; width: auto;
}
...
.menu2 ul li:hover ul li.hr:hover {
width: 100%;
background: #aaa;
}
...
display:block; background:#aaa; color:#fff;height:auto;line-height:15px;padding:4px 10px; width:auto; white-space: nowrap;
}
...
.paging a:hover { text-decoration:none; background-color: #dff4ff;  border-color:#c2e1ef;}
